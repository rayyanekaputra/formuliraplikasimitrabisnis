                    ...
                    <thead class="table-dark">
                        <tr>
                            <th colspan="6" scope="row" class="text-center">
                                <h1 class="mb-0">
                                    Formulir Aplikasi Mitra Bisnis
                                </h1>
                            </th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <td colspan="6" class="text-center">
                                <div>
                                    Mohon mengisi, menandatangani, dan mengembalikan formulir ini bersama dengan salinan
                        ...
                        <tr>
                            <td colspan="6" class="text-center">
                                <div>
                                    Untuk persetujuan mitra bisnis yang cepat scan/foto formulir ini (setelah di isi) &
                                    whatsapp ke sales atau hubungi ke (0411) 515559
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <th scope="row" colspan="1" class="fs-">Jenis Usaha*<br /> <small class="text-secondary">
                                    (Pilih
                                    Salah Satu) </small></th>
                        ...
                        <tr>
                            ...
                            <td class="align-middle" colspan="5">
                                <input v-model="formRegistrasi.informasiBisnis.nomorTelfonOutlet"
                                    class="w-100 form-control" type="text" placeholder="No Telf/WA Outlet" required>
                            </td>
                        </tr>
                        <tr>
                            <th scope="row">Alamat Outlet* <small class="text-secondary">(Alamat Pengiriman)</small>
                            </th>
                            <td class="align-middle" colspan="5">
                        ...
                        <tr>
                            ...
                            <td class="align-middle" colspan="2">
                                <select v-model="formRegistrasi.informasiBisnis.rutePengiriman"
